...
do
    echo CALL crearRecinto\(\'ubicacion${i}\', \'nombre${i}\'\)\; >> Prueba1.sql
done
i=$(($i-1))
...
#    echo ${combinacion[$numfechas]}
    echo CALL crearCalendario\(\'${combinacion[${numfechas}]}\'\)\; >> Prueba1.sql
...
#################################################################################################################################
    ...
    do
        ...
        echo CALL crearEvento\(\'DescripcionEspectaculo${espectaculo}\',\'Espectaculo${espectaculo}\',\'TipoEspectaculo${espectaculo}\',\'ParticipantesEspectaculo${espectaculo}\',$duracion,$penalizacion,\'${combinacion[$numfechas]}\',\'ubicacion${yy}\',$tiemposUno,$tiemposDos,$tiemposTres\)\; >> Prueba1.sql
        ...
        do
            ...
            echo CALL crearGrada\($maxEntradas,\'Grada${hugo}\',${precio},${precioJubilado},${precioParado},${precioInfantil},${precioBebe},${maxreservas},\'${combinacion[$numfechas]}\',\'ubicacion${yy}\'\)\; >> Prueba1.sql
            echo CALL crearUsuarios\(\'Grada${hugo}\', \'${combinacion[$numfechas]}\', \'ubicacion${yy}\', 1, 1, 1, 1, 1\)\; >> Prueba1.sql
            ...
            do 
                ...
                then
                    echo CALL crearLibres\(\'${ng}\',\'No Disponible\',\'Grada${hugo}\',\'${combinacion[$numfechas]}\',\'ubicacion${yy}\',\'$tipoUsuario\'\)\;  >> Prueba1.sql
                else
                    echo CALL crearLibres\(\'${ng}\',\'Disponible\',\'Grada${hugo}\',\'${combinacion[$numfechas]}\',\'ubicacion${yy}\',\'$tipoUsuario\'\)\;  >> Prueba1.sql
                fi
            done
        done
    done
