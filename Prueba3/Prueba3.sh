...
numeroRecintos=2000
numeroEspectaculos=25000
numeroFechas=500
anoMaximo=2125
numeroGradas=3
maximoEntradas=7    #Iran de 2 a este numero
...
do
    echo CALL crearRecinto\(\'ubicacion${i}\', \'nombre${i}\'\)\; >> Prueba3.sql
done
i=$(($i-1))
...
#    echo ${combinacion[$numfechas]}
    echo CALL crearCalendario\(\'${combinacion[${numfechas}]}\'\)\; >> Prueba3.sql
...
#################################################################################################################################
    ...
    do
        rand_espectaculo=$(($RANDOM%${numeroEspectaculos}))
        ...
        echo CALL crearEvento\(\'DescripcionEspectaculo${espectaculo}\',\'Espectaculo${espectaculo}\',\'TipoEspectaculo${espectaculo}\',\'ParticipantesEspectaculo${espectaculo}\',$duracion,$penalizacion,\'${combinacion[$numfechas]}\',\'ubicacion${yy}\',$tiemposUno,$tiemposDos,$tiemposTres\)\; >> Prueba3.sql
        ...
        do
            ...
            maxEntradas=$((2+${rand_maxEntradas}))
            
            echo CALL crearGrada\($maxEntradas,\'Grada${hugo}\',${precio},${precioJubilado},${precioParado},${precioInfantil},${precioBebe},${maxreservas},\'${combinacion[$numfechas]}\',\'ubicacion${yy}\'\)\; >> Prueba3.sql
            echo CALL crearUsuarios\(\'Grada${hugo}\', \'${combinacion[$numfechas]}\', \'ubicacion${yy}\', 1, 1, 1, 1, 1\)\; >> Prueba3.sql
            ...
            do 
                ...
                then
                    echo CALL crearLibres\(\'${ng}\',\'No Disponible\',\'Grada${hugo}\',\'${combinacion[$numfechas]}\',\'ubicacion${yy}\',\'$tipoUsuario\'\)\;  >> Prueba3.sql
                else
                    echo CALL crearLibres\(\'${ng}\',\'Disponible\',\'Grada${hugo}\',\'${combinacion[$numfechas]}\',\'ubicacion${yy}\',\'$tipoUsuario\'\)\;  >> Prueba3.sql
                fi
            done
        done
    done
